...
public class Dummy {
    ...
    public static void main(String[] args) {
        try {
            ...
            PreparedStatement p1=con.prepareStatement("truncate table cl");
            p1.executeUpdate();
            PreparedStatement p2=con.prepareStatement("truncate table cluster");
            p2.executeUpdate();
           ...
           rr51 +=rs.getInt(51);
            ...
            System.out.println("*********************************************");
            System.out.println(rr5+"rr5djfgjd sdfhsdvf dvdf");
           al.add(rr4); 
al.add(rr5); 
al.add(rr6); 
al.add(rr7); 
